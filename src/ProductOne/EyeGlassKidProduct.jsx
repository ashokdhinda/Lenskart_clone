...
import { EyeGlassessProducts } from '../json/EyeGlassess';
import Navbar from '../components/Navbar/Navbar';
import Footer from '../components/Footer/Footer';
const EyeGlassKidProduct = () => {
    const { id } = useParams();
    const toast = useToast();

    const selectedItem = EyeGlassessProducts.find((item) => item.id === id);
...
export default EyeGlassKidProduct
