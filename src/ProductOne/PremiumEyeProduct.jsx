...
import { PrimiumProducts } from '../json/PREMIMUMEYE';
import Navbar from '../components/Navbar/Navbar';
import Footer from '../components/Footer/Footer';
const PremiumEyeProduct = () => {
   const { id } = useParams();
   const toast = useToast();
 const selectedItem = PrimiumProducts.find((item) => item.id === id);
...
export default PremiumEyeProduct
